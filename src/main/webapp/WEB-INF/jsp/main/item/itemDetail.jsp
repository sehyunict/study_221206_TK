...
<jsp:include page="../header.jsp"/>
 ...
 <section class="taxMain">
	<div id="taxMainStyle_A1" class="taxMainStyle">
		<h1 align="center">상세페이지</h1>
	</div>
		<div id="taxMainStyle_A2" class="taxMainStyle">
			<table border="1">
				<tr>
					<td rowspan="3">
						<img id="musical_1_detail" src="../resources/image/musical_1.jpg">
					</td>
					<td ></td>
					<td>제목</td>
					<td>
						<p id="defaultInfo1" name="duty"> ${memberDto.getDuty()} </p>
					</td>
				</tr>
				<tr>
					<td></td>
					<td>감독</td>
					<td>
						<p id="defaultInfo2" name="duty"> ${memberDto.getDuty()} </p>
					</td>
				</tr>
				<tr>
					<td></td>
					<td>줄거리</td>
					<td>
						<p id="defaultInfo3" name="duty"> ${memberDto.getDuty()} </p>
					</td>
				</tr>	
